<?php
		  ...
		  $article_h1_text = $article_dom->createTextNode("Permalinking done!");
		  ...
		  $article_date_h3_text = $article_dom->createTextNode("Sat, 20 Apr 2013 00:21:01 -0400");
		  ...
		  $article_description_p_text = $article_dom->createTextNode("I'm finally done adding and testing permalinking. If it breaks for whatever reason I also made a permalink reset tool to remake the article pages and their permalinks.");
