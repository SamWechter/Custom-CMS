<?php
		  ...
		  $article_date_h3_text = $article_dom->createTextNode("Fri, 19 Apr 2013 22:23:17 -0400");
		  ...
		  $article_description_p_text = $article_dom->createTextNode("testing RSS feed generation");
