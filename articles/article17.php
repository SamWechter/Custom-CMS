<?php
		  ...
		  $article_h1_text = $article_dom->createTextNode("Article Permalinking");
		  ...
		  $article_date_h3_text = $article_dom->createTextNode("Fri, 19 Apr 2013 22:31:20 -0400");
		  ...
		  $article_description_p_text = $article_dom->createTextNode("I'm working on setting up article permalinks now.");
