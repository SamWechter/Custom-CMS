<?php
		  ...
		  $article_h1_text = $article_dom->createTextNode("Project 2 Done!");
		  ...
		  $article_date_h3_text = $article_dom->createTextNode("Sun, 21 Apr 2013 23:49:54 -0400");
		  ...
		  $article_description_p_text = $article_dom->createTextNode("I'm finally done with project 2! Woohoo!");
