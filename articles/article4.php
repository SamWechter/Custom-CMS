<?php
		  ...
		  $article_h1_text = $article_dom->createTextNode("A contact form is on the way!");
		  ...
		  $article_date_h3_text = $article_dom->createTextNode("19:06:18 03-29-2013");
		  ...
		  $article_description_p_text = $article_dom->createTextNode("I'm working on a contact form so visitors to this site can reach me. It should be up in about 30-40 minutes so stay tuned!");
