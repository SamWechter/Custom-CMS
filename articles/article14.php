<?php
		  ...
		  $article_h1_text = $article_dom->createTextNode("Project Submitted!");
		  ...
		  $article_date_h3_text = $article_dom->createTextNode("22:31:37 03-29-2013");
		  ...
		  $article_description_p_text = $article_dom->createTextNode("I am submitting this project now. Hopefully I'll get an A!");
