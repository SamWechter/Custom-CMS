<?php
		  ...
		  $article_h1_text = $article_dom->createTextNode("Submitting the project soon");
		  ...
		  $article_date_h3_text = $article_dom->createTextNode("21:52:02 03-29-2013");
		  ...
		  $article_description_p_text = $article_dom->createTextNode("I'm almost finished with the extras on this project so I'm submitting it soon. Wish me luck!");
