<?php
		  ...
		  $article_h1_text = $article_dom->createTextNode("About page");
		  ...
		  $article_date_h3_text = $article_dom->createTextNode("21:13:53 03-29-2013");
		  ...
		  $article_description_p_text = $article_dom->createTextNode("I am currently designing the about page and creating content for it. It should be up shortly!");
