<?php
		  ...
		  $article_h1_text = $article_dom->createTextNode("Server-side? What about client-side?");
		  ...
		  $article_date_h3_text = $article_dom->createTextNode("21:20:48 03-29-2013");
		  ...
		  $article_description_p_text = $article_dom->createTextNode("You can find all of my coursework for Client-Side Programming at: http://people.rit.edu/~saw7456/536/");
