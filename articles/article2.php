<?php
		  ...
		  $article_h1_text = $article_dom->createTextNode("test 3");
		  ...
		  $article_date_h3_text = $article_dom->createTextNode("00:39:05 03-29-2013");
		  ...
		  $article_description_p_text = $article_dom->createTextNode("This is yet another news article.");
