<?php
		  ...
		  $article_h1_text = $article_dom->createTextNode("Admin feed selection done and advertisements are on the way!");
		  ...
		  $article_date_h3_text = $article_dom->createTextNode("Sat, 20 Apr 2013 22:06:01 -0400");
		  ...
		  $article_description_p_text = $article_dom->createTextNode("I'm done with the core requirements for the project now. I'm working on setting up an advertisements page now with the appropriate controls on the admin page. Weighted banners are on the agenda next after that.");
