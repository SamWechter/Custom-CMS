<?php
		  ...
		  $article_h1_text = $article_dom->createTextNode("About page cancelled");
		  ...
		  $article_date_h3_text = $article_dom->createTextNode("21:44:49 03-29-2013");
		  ...
		  $article_description_p_text = $article_dom->createTextNode("I decided to hold off on the about page since it was being finicky with text formatting. Don't worry, it'll get content in the future.");
