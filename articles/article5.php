<?php
		  ...
		  $article_h1_text = $article_dom->createTextNode("Contact form done!");
		  ...
		  $article_date_h3_text = $article_dom->createTextNode("20:52:27 03-29-2013");
		  ...
		  $article_description_p_text = $article_dom->createTextNode("The contact form is done! While I was at it I also added the ability to change the number of news items per page in the News section.");
