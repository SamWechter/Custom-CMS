<?php
		  ...
		  $article_h1_text = $article_dom->createTextNode("Gone Fishing");
		  ...
		  $article_date_h3_text = $article_dom->createTextNode("21:43:56 03-29-2013");
		  ...
		  $article_description_p_text = $article_dom->createTextNode("I'm going to New York City for the weekend so after submitting this project I'm putting updates on hold until I get back. Please be patient with email responses!");
