<?php
		  ...
		  $article_h1_text = $article_dom->createTextNode("Base Requirements Completed!");
		  ...
		  $article_date_h3_text = $article_dom->createTextNode("19:00:52 03-29-2013");
		  ...
		  $article_description_p_text = $article_dom->createTextNode("I just completed the base requirements for this project. I am the greatest!");
