<?php
		  ...
		  $article_h1_text = $article_dom->createTextNode("Commentacular!");
		  ...
		  $article_date_h3_text = $article_dom->createTextNode("22:07:39 03-29-2013");
		  ...
		  $article_description_p_text = $article_dom->createTextNode("I'm going back through all of my PHP code now to add comments and change the spacing to enhance readability. PHP: Now 50% more headache-free!");
