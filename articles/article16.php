<?php
		  ...
		  $article_h1_text = $article_dom->createTextNode("RSS Feed Debugging Completed");
		  ...
		  $article_date_h3_text = $article_dom->createTextNode("Fri, 19 Apr 2013 22:27:15 -0400");
		  ...
		  $article_description_p_text = $article_dom->createTextNode("I'm finished debugging my news RSS feed now. Parse away!");
