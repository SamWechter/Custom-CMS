<?php
		  ...
		  $article_h1_text = $article_dom->createTextNode("Appture is hiring!");
		  ...
		  $article_date_h3_text = $article_dom->createTextNode("22:10:53 03-29-2013");
		  ...
		  $article_description_p_text = $article_dom->createTextNode("Appture LLC, a Rochester-based tech startup, is looking for experienced web and mobile application developers! We are in the process of talking with RIT about giving co-op credit over the summer and have applied for a position at the RIT business incubator. Please leave me a message through the Contact page if you'd like more information.");
